...
var ReactSlickGrid = React.createClass({
    ...
    _initializeSlickGrid: function () {
        ...
        var id = $(this.refs.grid);
        var ele = $(ReactDOM.findDOMNode(this.refs.grid));

        this._slickgrid = new SlickGrid(ele, rows, columns, options);
    ...
    render: function () {
        return (
            <div id={this.props.id} ref='grid' style={this.props.style}></div>
        );
    }
});
export default ReactSlickGrid;